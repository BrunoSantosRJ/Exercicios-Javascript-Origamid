...
var pesoPorDois = numero / 2 //Resposta: pare resolver esta tarefa é necessário substituir peso por numero
...
//resposta correta 3
//Errei. justificativa: imaginei que 5 - ' ' seria um valor falso por isso retornaria false.
...
addEventListener('scroll', function () {
  //meuNomeCompleto = 'Bruno Santos';
  return console.log('Bruno Santos')
})
...
cachorro = {
  ...
  late(genero) {
    if (genero === 'homem') {
      ...
      return console.log(
        'Você digitou um gênero inválido, digite "homem" ou "mulher"'
      )
    }
  }
}
...
// estava escrito var dentro do resultado exibido ao invés de "cor".
...
const total1 = 50 * numero
console.log(total1)

//R: Alterar o valor de 'numero < 10' para 'numero < 50' ou na linha 418, alterar o valor de
//10 * numero para 50* numero
